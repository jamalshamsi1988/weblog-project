...
import { GET_POST_INFO } from '../graphql/quaries';
    ...
    <Container maxWidth="lg" >
      <Grid container >
        <Grid item xs={12} mt={9} display="flex" justifyContent="space-between" >
          <Typography component="h2" variant='h5'  color="primary" fontWeight={700}>{data.post.title}</Typography>
            <ArrowBackRoundedIcon onClick={()=> navigate(-1)} />
        </Grid>
        <Grid item xs={12} mt={6} >
          <img src={data.post.coverPhoto.url} width="100%"  style={{borderRadius:15}} alt={data.post.slug}/>
        </Grid>
